...
// //3.1 Is Array;
// //3.2 Is Array, Object, Number, Boolean, String.
// //3.2 
// // for (let i=0;i<5;i++){
// // var {jobTitle, locations, jobSalary, benefits, skills, jobRequirement}=jobSearch.hits[i];
...
//     done: "When your task is complete, the only thing you have to do is to wait for users to use it (no additional codes or action needed",
